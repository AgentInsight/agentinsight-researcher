...
def test_make_cache_key_returns_64_hex_string() -> None:
    """测试返回 64 位 hex 字符串 (sha256 摘要长度)."""
...
def test_make_cache_key_matches_sha256_format() -> None:
    """测试 key 等于 sha256(query:tool_name:args_json) 的 hexdigest."""
    query = "my query"
