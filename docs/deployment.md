...
# 返回 {"status":"ok","service":"agentinsight-researcher","version":"0.1.0"}
```
...
# Agent 健康检查
curl http://localhost:8066/health
# {"status":"ok","service":"agentinsight-researcher","version":"0.1.0"}
...
```bash
curl http://localhost:8066/health
# Returns {"status":"ok","service":"agentinsight-researcher","version":"0.1.0"}
```
